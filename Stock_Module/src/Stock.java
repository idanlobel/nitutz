...
public Stock ()
{
 ...
 public void Sale(int products_id,int sales_id, LocalDate startdate ,LocalDate endate, String reason, double percentage)
 {
     ...
     for (Products products:this.products_list) {
         if(products.getID()==products_id)
         {
             if(!foundsale) {
                 ...
                 Sale new_sale = new Sale(percentage, LocalDate.now(), endate, reason,products);
                 products.Record_sale(percentage);
