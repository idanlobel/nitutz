...
public  class DAL_controller_test {
    ...
    private static DAL_controller_test instance=new DAL_controller_test();
    ...
    private DAL_controller_test()
    {

        this.connection_string="jdbc:sqlite:"+System.getProperty("user.dir")+"\\..\\dev\\test_database.db";
    ...
    public static DAL_controller_test getInstance(){
        return instance;
    }
